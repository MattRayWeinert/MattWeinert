        ...
        <div class="home-wrapper">
            ...
            <div class="container" style={{width: "100%", justifyContent: "space-evenly"}}>
                ...
                <div class="right">
                    ...
                    <div class="experience" id="experience" ref={ref} style={divStyle}>
                        <div class="section">
                            <div>
                    ...
                    <div class="portfolio" id="portfolio" ref={ref2} style={divStyle2}>
                        <div class="section">
                    ...
                    <div class="section" ref={ref3} style={divStyle3}>
                        <div class="body">
